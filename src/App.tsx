        ...
        {pageView === "dashboard" && (
          <main className="dash-main">
            <div className="dashboard-grid">
              <section className="card dashboard-card dashboard-income">
                <div className="card-header">
                  <div className="card-title">Revenus</div>
                  <div className="card-subtitle">Cette semaine</div>
                </div>
                <div className="card-content income-body">
                  <div className="income-hero">
                    <div className="avatar-lg" aria-hidden="true">
                      <img src="https://i.pravatar.cc/120?img=47" alt="" />
                    </div>
                    <div>
                      <div className="income-amount">12 450 €</div>
                  ...
                  <svg className="line-chart" viewBox="0 0 220 80" aria-hidden="true">
                    <path
                      d="M5 60 C30 20, 60 20, 85 50 C110 85, 140 70, 170 30 C190 10, 210 20, 215 35"
                      fill="none"
              ...
              <section className="card dashboard-card dashboard-earnings">
                <div className="card-header">
                  <div className="card-title">Rapport des gains</div>
                  <div className="card-subtitle">@artanes</div>
                </div>
                <div className="card-content earnings-body">
                  <div className="donut" aria-hidden="true">
                    <div className="donut-center">24 300 €</div>
                  </div>
                  <div className="legend">
                    <div className="legend-item">
                      <span className="legend-dot dot-primary" />
                      Projets
                    </div>
                    <div className="legend-item">
                      <span className="legend-dot dot-secondary" />
                      Produits
                    </div>
                    <div className="legend-item">
              ...
              <section className="card dashboard-card dashboard-projects">
                <div className="card-header">
                  <div className="card-title">Vos projets</div>
                  <div className="card-subtitle">@artanses</div>
                </div>
                <div className="card-content project-list">
                  <div className="project-row">
                    <div className="project-icon">📣</div>
                    <div>
                      <div className="project-name">Campagne marketing</div>
                      <div className="project-meta">Échéance 18 avr</div>
                    </div>
                    <div className="project-amount">183 000 €</div>
                  </div>
                  <div className="project-row">
                    <div className="project-icon">🧭</div>
                    <div>
                      <div className="project-name">Recherche UX</div>
                      <div className="project-meta">Échéance 12 sept</div>
                    </div>
                    <div className="project-amount">12 000 €</div>
                  </div>
                  <div className="project-row">
                    <div className="project-icon">🧩</div>
                    <div>
                      <div className="project-name">Design dashboard</div>
                      <div className="project-meta">Échéance 14 oct</div>
                    </div>
                    <div className="project-amount">16 800 €</div>
                  </div>
                </div>
              </section>

              <section className="card dashboard-card dashboard-activity">
                <div className="card-header">
                ...
                <div className="card-content activity-list">
                  <div className="activity-row">
                    <img className="avatar-sm" src="https://i.pravatar.cc/64?img=32" alt="" />
                    <div>
                      <div className="activity-name">Corissa Hellene-Hodesson</div>
                      <div className="activity-meta">il y a 1 h</div>
                    </div>
                    <span className="status-pill status-done">Terminé</span>
                  </div>
                  <div className="activity-row">
                    <img className="avatar-sm" src="https://i.pravatar.cc/64?img=12" alt="" />
                    <div>
                      <div className="activity-name">Dave Helmett-Olodofist</div>
                      <div className="activity-meta">il y a 2 j</div>
                    </div>
                    <span className="status-pill status-done">Terminé</span>
                  </div>
                  <div className="activity-row">
                    <img className="avatar-sm" src="https://i.pravatar.cc/64?img=5" alt="" />
                    <div>
                      <div className="activity-name">Durra Hathaway-Olodofist</div>
                      <div className="activity-meta">il y a 5 j</div>
                    </div>
              ...
              <section className="card dashboard-card dashboard-task">
                <div className="card-header">
                  <div className="card-title">Créer une tâche</div>
                  <div className="card-subtitle">Nouvelle entrée</div>
                </div>
                <div className="card-content task-body">
                  <label className="label">Nom de la tâche</label>
                  <input className="select" placeholder="Ex: Modèle de coût" />
                  <label className="label">Membres</label>
                  <input className="select" placeholder="Ajouter une personne" />
                  <div className="task-row">
                    <span className="chip">25 avr</span>
                    <span className="chip">Haute</span>
                    <span className="chip">Basse</span>
                  </div>
                  <div className="task-avatars">
                    <img src="https://i.pravatar.cc/48?img=40" alt="" />
                    <img src="https://i.pravatar.cc/48?img=16" alt="" />
                    <img src="https://i.pravatar.cc/48?img=9" alt="" />
              ...
              <section className="card dashboard-card dashboard-analytics">
                <div className="card-header">
                  <div className="card-title">Aperçu analytique</div>
                  <div className="card-subtitle">+118,7% ce mois</div>
                </div>
                <div className="card-content analytics-body">
                  <div className="analytics-chart">
                    {["20%", "35%", "40%", "55%", "70%", "65%", "85%"].map((h, i) => (
                      <span key={h + i} className="bar" style={{ height: h }} />
                    ))}
                  </div>
